 ...
 * Takes an 2-dimensional array of doubles and returns the product of the rows 
 * or columns in a row or column vector. 
 * ===================================================================
 */
...
void prod(double **m,int rows,int cols,double **mout,int dim){
    int i,j;
