 ...
 *
 *         double y1=add(double u1,double u2)
 *
 *    Simulink version           : 10.4 (R2021b) 14-May-2021
 *    C source code generated on : 27-Nov-2021 10:40:45
 *
...
#define S_FUNCTION_NAME  S_function1
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "add", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
