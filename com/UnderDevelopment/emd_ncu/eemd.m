...
%  Copyright (C) National Central University; 2013
%  ***** For Educational and Academic Purposes Only ********* 
%  Author : Yung-Hung Wang, ME, NCU
%
% Please Cite: 
...
% fprintf('Copyright (C) ME, NCU, Taiwan.\n');
...
if (NoiseLevel == 0)
    allmode = emd_ncu(Y, toModifyBC, typeSpline, numImf, maxSift);
    allmode = allmode';
    return;
end
