...
%alpha1=polyfit(log(4:16),lf(4:16),1);
%alpha2=polyfit(log(16:64),lf(16:64),1);
% Perform DFA2 ?
if nargout > 2
    quadRreg = 1; % yes
else
...
% Column Major
if size(signal,2) == 1
    signal = transpose(signal);signal
end

% This scale factor is usealpha1=polyfit(log(4:16),lf(4:16),1);
%alpha2=polyfit(log(16:64),lf(16:64),1);d to evenly space the ouput on a log scale
