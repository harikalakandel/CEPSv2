%function [] = quick_test_DHellinger()
%Quick test for Hellinger distance estimators: analytical expression vs estimated value as a function of the sample number. In the test, normal variables are considered. See also 'analytical_value_DHellinger.m'.
...
%distr, d -> samples, analytical value (D):
    switch distr
        case 'normal'
            %mean:
                m1 = rand(d,1);
    ...
    %analytical value:
        D = analytical_value_DHellinger(distr,distr,par1,par2);
