function [co] = DRenyi_vME_initialization(mult,post_init)
%function [co] = DRenyi_vME_initialization(mult)
%function [co] = DRenyi_vME_initialization(mult,post_init)
%Initialization of the von Mises expansion based Renyi divergence estimator.
%
%Note:
