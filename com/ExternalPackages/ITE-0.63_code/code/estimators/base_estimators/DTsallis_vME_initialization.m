function [co] = DTsallis_vME_initialization(mult,post_init)
%function [co] = DTsallis_vME_initialization(mult)
%function [co] = DTsallis_vME_initialization(mult,post_init)
%Initialization of the von Mises expansion based Tsallis divergence estimator.
%
%Note:
