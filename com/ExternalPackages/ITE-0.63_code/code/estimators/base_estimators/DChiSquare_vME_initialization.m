function [co] = DChiSquare_vME_initialization(mult)
%function [co] = DChiSquare_vME_initialization(mult)
%Initialization of the von Mises expansion based Pearson chi-square divergence estimator.
%
%Note:
