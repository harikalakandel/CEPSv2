function [D] = DChiSquare_vME_estimation(Y1,Y2,co)
%function [D] = DChiSquare_vME_estimation(Y1,Y2,co)
%Estimates the Pearson chi-square divergence (D) of Y1 and Y2 using von Mises expansion. 
%
