function [co] = condHShannon_HShannon_initialization(mult,post_init)
%function [co] = condHShannon_HShannon_initialization(mult)
%function [co] = condHShannon_HShannon_initialization(mult,post_init)
%Initialization of the conditional Shannon entropy meta-estimator defined according to the relation: H(y^1|y^2) = H([y^1;y^2]) - H(y^2), where H is the Shannon differential entropy.
%
%Note:
%   1)The estimator is treated as a cost object (co).
%   2)We use the naming convention 'condH<name>_initialization' to ease embedding new conditional entropy estimation methods.
